...
public class Boletin2_4 {
    ...
    public static void main(String[] args) {
        ...
        t= ler.nextInt();
        b100=t/100;r=t%100; t=t-(t-r); //cojemos el cociente como resultado para la cantidad de villetes, tras eso calculamos el resto y se lo restamos al total.
        b20=t/20;r=t%20;t=t-(t-r);
        b5=t/5;r=t%5;
        m1=r;
